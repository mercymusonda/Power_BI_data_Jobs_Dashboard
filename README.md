...
![Data Jobs DB GIF](/Images/page1_data_jobs_dashboard.png)

**⬇️ Download `Data_Jobs_Dashboard.pbix` inside "Data_Jobs_V1" file and open in Power BI Desktop to interact**
...
![Data Jobs Dashboard 2.0](/Images/data_jobs_dashboard_2.0.png)

**⬇️ Download `Data_Jobs_2.0.pbix` inside "Data_Jobs_V2" file  and open in Power BI Desktop to interact**

**🛠️ Key Power BI Skills Utilized (demonstrating progression):**
- 🎨 Advanced Dashboard Design (Single-Page UX & Optimization)
- 🔄 Complex Power Query Transformations
- 🗄️ Star Schema Data Modeling Principles
...
- ⚙️ Report Performance Considerations
